...
connection.connect(function(err) {
  if (err) {
    ...
    connection.query("UPDATE `beta_users` SET `power`='3'   WHERE `id`='"+reason2+"'", (error,  result) => {
         ...
         const embed = new Discord.RichEmbed()
		   ...
		   .setTitle("Successfully Made a Trial Staff!")
                		       		   .setDescription("The user has now been made a Trial Staff on our site.")
