...
connection.connect(function(err) {
  if (err) {
    ...
    connection.query("UPDATE `beta_users` SET `power`='0'   WHERE `id`='"+reason2+"'", (error,  result) => {
         ...
         const embed = new Discord.RichEmbed()
		   ...
		   .setTitle("Successfully Fired!")
                		       		   .setDescription("The user has now been fired from our site.")
