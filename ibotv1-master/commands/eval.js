...
module.exports.run =  ((Discord, client, message, args) => {
  const embed2 = new Discord.RichEmbed()
          .setTitle(":x: You will need Admin for this.")
          .setDescription(
            "Your not authorised to use this command at Sunrise Hotels. You must be a Admin to use this command."
          )
          .setColor("RED");
      if (!message.member.roles.find(r => r.name === "+ Admin" )) return message.channel.send(embed2) 
